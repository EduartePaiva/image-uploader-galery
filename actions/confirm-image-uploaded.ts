...
// lambda stuff
import { InvokeCommand, InvokeCommandInput, LambdaClient } from "@aws-sdk/client-lambda"; // ES Modules import
const lambdaClient = new LambdaClient({
    region: env.MY_AWS_LAMBDA_REGION,
    credentials: {
        accessKeyId: env.MY_AWS_ACCESS_KEY,
        secretAccessKey: env.MY_AWS_SECRET_ACCESS_KEY,
    },
...
export default async function confirmImageUploaded(unparsedDraftPostId: string) {
    try {
        ...
        const input: InvokeCommandInput = {
            // InvocationRequest
            FunctionName: env.MY_AWS_LAMBDA_NAME, // required
